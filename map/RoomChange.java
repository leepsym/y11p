...
public class RoomChange {
    public static void enterRoom(Room currentRoom, Room nextRoom) { // Method for entering new rooms, parameters for the room the player is in and is attempting to enter
        ...
        Enemy nextEnemy = nextRoom.getEnemy(); // Assigns nextEnemy to the enemy in the room the player is trying to enter
        Enemy currentEnemy = currentRoom.getEnemy(); // Assigns currentEnemy to the enemy in the room the player is currently in
