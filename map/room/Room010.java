...
public class Room010 extends Room { // Initialises Room010 with Room as its superClass
    public Room010() {
        ...
        this.directions[1] = new Room011(); // Referenced to not cause a bug in Workbench when modifying weapon in this room
        this.enemy = new Troll(30, 40, new Club(null, 0, 0 ,0, 0));
        this.roomDescription = "A faint light seeps through a crack in the wall, accompanied by a small breeze that stirs the stale air. The scent of aged stone lingers. A way out to the east through the crack in the wall presents an escape from this lair";
    }
}