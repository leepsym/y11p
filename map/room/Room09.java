...
public class Room09 extends Room { // Initialises Room09 with Room as its superClass
    ...
    public Room09() {
        ...
        this.roomDescription = "Shadows dance across the walls, cast by unseen flames. The silence is oppressive. One last exit to the east provides a route of escape.";
    }
}