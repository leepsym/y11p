...
public class ShortBow extends Weapon { // Initialises the Stick class with Weapon as its superclass
    public ShortBow(String name, int hitBonus, int baseDamage, int bonusDamage, int damageDiceSides) { // Creates a constructor for each new instance with the following parameters: name, hitBonus, baseDamage, bonusDamage, and damageDiceSides
